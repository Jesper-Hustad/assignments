"""
Inspired from Jose Maynez https://medium.com/@flomay/using-q-learning-to-solve-the-cartpole-balancing-problem-c0a7f47d3f9d
"""
...
class CartPoleQAgent():
    def __init__(self, buckets=(6, 12),
        ...
        print("aaa", self.buckets + (self.env.action_space.n,))
    ...
    def train(self, print_steps=False, render=False):
        ...
        for e in range(self.num_episodes):
            ...
            while not done:
                ...
                # Run the action in the enviroment (gym)
                observation, reward, done, _ = self.env.step(action)
                # Create new S (angle, angle_velocity)
